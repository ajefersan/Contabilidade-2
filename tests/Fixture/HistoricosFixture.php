...
class HistoricosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'usuario_id' => ['type' => 'index', 'columns' => ['users_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'codigo' => ['type' => 'unique', 'columns' => ['codigo'], 'length' => []],
            'historicos__users_id___users__id' => ['type' => 'foreign', 'columns' => ['users_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
